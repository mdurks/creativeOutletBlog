export const techIconData = {
  ...
  IconArray: {
    ...
    cuboidColliderArgs: [1.1, 0.25, 1.1],
    modelName: "IconArray",
    scale: [1.3, 1.3, 1.3],
  },
  IconParens: {
  ...
  IconSuzanne: {
    ...
    cuboidColliderArgs: [1.5, 1, 1],
    modelName: "IconSuzanne",
    scale: [1, 1, 1],
  },
  IconGear: {
    path: "/models/IconGear.glb",
    cuboidColliderArgs: [1.4, 0.5, 1.4],
    modelName: "IconGear",
    scale: [1, 1, 1],
  },
  IconTorus: {
  ...
  IconCone: {
    ...
    cuboidColliderArgs: [1.35, 1, 1.3],
    modelName: "IconCone",
    scale: [1, 1, 1],
  },
  IconSphere: {
    path: "/models/IconSphere.glb",
    cuboidColliderArgs: [1, 1, 1],
  ...
  IconTeapot: {
    path: "/models/IconTeapot.glb",
    cuboidColliderArgs: [1.5, 1, 1.1],
    modelName: "IconTeapot",
